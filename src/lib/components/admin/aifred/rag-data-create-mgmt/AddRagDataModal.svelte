...
<Modal size="sm" bind:show>
	<div>
		<div class=" flex justify-between dark:text-gray-300 px-5 pt-4 pb-2">
			<div class=" text-lg font-medium self-center">항목추가</div>
			<button
				class="self-center"
				on:click={() => {
					show = false;
				...
				>
					<div class="px-1">
						...
						<div class="flex flex-col w-full mb-3">
							<div class=" mb-1 text-xs text-gray-500">대상인덱스</div>
							<div class="flex-1">
								<select
						...
						<div class="flex flex-col w-full mt-1 mb-3">
							<div class=" mb-1 text-xs text-gray-500">타겟경로</div>
						...
						<div class="flex flex-col w-full mb-3">
							<div class=" mb-1 text-xs text-gray-500">처리유형</div>
							<div class="flex-1">
								<select
									class="w-full capitalize rounded-lg text-sm bg-transparent dark:disabled:text-gray-500 outline-hidden"
									bind:value={_user.role}
						...
						<div class="flex flex-col w-full mb-3">
							<div class=" mb-1 text-xs text-gray-500">처리여부</div>
							<div class="flex-1">
								<select
									class="w-full capitalize rounded-lg text-sm bg-transparent dark:disabled:text-gray-500 outline-hidden"
									bind:value={_user.role}
						...
						<div class="flex flex-col w-full mt-1 mb-3">
							<div class=" mb-1 text-xs text-gray-500">처리결과</div>
